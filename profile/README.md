...
- Support for Node.js, TypeScript, Go, Rust, Python and any executable
- Lightning fast (written in Zig)
- Minimal dependencies
- Intuitive web-based UI for easy process management and monitoring.
